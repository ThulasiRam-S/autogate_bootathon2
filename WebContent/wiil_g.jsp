...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from garage_gate_opener where mid=3");
...
%>  
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/garagedoor_opener/WILL-G.jpg" width="370" height="400">
    				<h3>WILL-G GARAGE GATE OPENER</h3>
    			</div>
    			<div class="col-md-4">
    				 <table class="table table-striped table table-bordered" style="border: 1px solid; color: black;">
                <tr >
                    <td>MODEL</td><td>WILL-G GARAGE GATE OPENER</td>
