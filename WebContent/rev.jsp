...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from sliding_gate where mid=5");
...
%>  
	    <div class="menu-bar">
	    	<div class="row">
	            ...
	            <ul class="nav" >
	                <li><a href="sliding_gate.jsp">Back</a></li>
	           </ul>
	    	</div>
	    </div>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/sliding_motor/REV_PRINCIPALE_1.jpg" width="370" height="400">
    				<h3>REV SLIDING GATE</h3>
    			</div>
    			<div class="col-md-4">
    				 <table class="table table-striped table table-bordered" style="border: 1px solid; color: black;">
                <tr >
                    <td>MODEL</td><td>REV-340N</td>
                ...
                <tr>
                    ...
                    <td>AMBIENT TEMPERATURE RANGE</td><td>-20 ~ +40</td>
                   
                </tr>
                <tr>
                   
                    <td>Max.GATE WEIGHT</td><td>1400kg</td>
