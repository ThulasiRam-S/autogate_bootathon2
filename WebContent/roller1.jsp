...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from roller_gate_opener where mid=1");
...
%>  
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/roller motor/roller1.jpeg" width="370" height="400">
    				<h3>DAWEI ROLLER GATE OPENER</h3>
    			</div>
    			<div class="col-md-4">
...
Dawei</td>
                ...
                <tr>
                    ...
                    <td>INPUT POWER(W)</td><td>220v</td>
                ...
                <tr>
                    ...
                    <td>Max.GATE WEIGHT</td><td>300kg</td>
