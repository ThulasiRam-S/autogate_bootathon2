...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from garage_gate_opener where mid=2");
...
%>  
	    <div class="menu-bar">
	    	<div class="row">
	    		<div class="logo">
	                <a href="#" class="logo" style="text-decoration: none;">Secure Gate Automation</a>
	            </div>
	            <ul class="nav" >
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/garagedoor_opener/20150302204338651.jpg" width="370" height="400">
    				<h3>INDUSTRIAL DOOR OPENER
(F-850E)</h3>
    			</div>
    			<div class="col-md-4">
    				 <table class="table table-striped table table-bordered" style="border: 1px solid; color: black;">
                <tr >
                    <td>MODEL</td><td>INDUSTRIAL DOOR OPENER
(F-850E)</td>
                   
                </tr>
                <tr>
                    
                    <td>RATED VOLTAGE</td><td>AV240V 50/60Hz</td>
                ...
                <tr>
                    ...
                    <td>Max.GATE WEIGHT</td><td>1000</td>
