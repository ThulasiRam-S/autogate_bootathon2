...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from sliding_gate where mid=4");
...
%>  
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/sliding_motor/LIVI-N-PRINCIPALE-2.jpg" width="370" height="400">
    				<h3>LIVI/N SLIDING GATES</h3>
    			</div>
    			<div class="col-md-4">
    				 <table class="table table-striped table table-bordered" style="border: 1px solid; color: black;">
                <tr >
                    <td>MODEL</td><td>LIVI/N SLIDING MOTOR</td>
                ...
                <tr>
                    ...
                    <td>Max.GATE WEIGHT</td><td>900kg</td>
                   
                </tr>
                <tr>
                   
                    <td>MOVING SPEED(m/min)</td><td>>12</td>
