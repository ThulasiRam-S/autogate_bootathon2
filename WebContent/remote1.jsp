...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from remotes where mid=1");
...
%>  
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/accessories/remote1.jpg" width="370" height="400">
    				<h3 style="font-size: 20px;">WIRELESS RF REMOTE CONTROL</h3>
    			</div>
    			<div class="col-md-4">
    				 <table class="table table-striped table table-bordered" style="border: 1px solid; color: black;">
                <tr >
                    <td>MODEL NAME</td><td>WIRELESS RF REMOTE CONTROL</td>
                   
                </tr>
                <tr >
                    <td>MODEL NUMBER</td><td>YET2133MJR</td>
