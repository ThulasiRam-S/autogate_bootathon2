...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from sliding_gate where mid=2");
...
%>  
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/sliding_motor/201503022138416499.jpg" width="370" height="400">
    				<h3>DC SLIDING GATE OPENER
(F-550G)</h3>
    			</div>
    			<div class="col-md-4">
    				 <table class="table table-striped table table-bordered" style="border: 1px solid; color: black;">
                <tr >
                    <td>MODEL</td><td>F-550G</td>
