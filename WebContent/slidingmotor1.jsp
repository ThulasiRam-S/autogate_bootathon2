...
%>  
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/sliding_motor/201503022124014674.jpg" width="370" height="400">
    				<br><br>
    				<h3 style="font-size: 20px;">DC SLIDING GATE OPENER
(F-550M)
    				</h3>
    			</div>
    			<div class="col-md-4">
                ...
                <tr>
                    ...
                    <td>Max.GATE WEIGHT</td><td>600kg</td>
