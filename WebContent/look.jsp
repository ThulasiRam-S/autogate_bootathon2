...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from swing_gate where mid=1");
...
%>  
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/swing_motor/LOOK-PRINCIPALE.jpg" width="370" height="400">
    				<h3>LOOK SWING GATE OPENER</h3>
    				
    			</div>
    			<div class="col-md-4">
    				 <table class="table table-striped table table-bordered" style="border: 1px solid; color: black;">
                <tr >
                    <td>MODEL</td><td>LOOK SWING GATE</td>
                ...
                <tr>
                    ...
                    <td>Max.GATE WEIGHT</td><td>280kg</td>
                   
                </tr>
                <tr>
                   
                    <td>LENGTH</td><td>5 METERS</td>
