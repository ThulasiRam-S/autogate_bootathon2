...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from sensors where mid=5");
...
%>  
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/accessories/sensor5.jpg" width="370" height="400">
    				<h3 style="font-size: 20px;">GATE SAFETY EDGES AND PHOTOCELLS YET606</h3>
    			</div>
    			<div class="col-md-4">
    				 <table class="table table-striped table table-bordered" style="border: 1px solid; color: black;">
                <tr >
                    <td>MODEL</td><td>Gate Safety Edges and Photocells YET606  </td>
