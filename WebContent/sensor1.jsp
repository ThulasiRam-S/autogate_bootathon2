...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from sensors where mid=1");
...
%>  
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/accessories/sensor1.jpg" width="370" height="400">
    				<h3>LSR LASER SAFETY SENSOR</h3>
    			</div>
    			<div class="col-md-4">
    				 <table class="table table-striped table table-bordered" style="border: 1px solid; color: black;">
                <tr >
                    <td>MODEL</td><td>LSR Laser Safety Sensor </td>
                ...
                <tr>
                    ...
                    <td>THEORY</td><td>Inductance Sensor</td>
