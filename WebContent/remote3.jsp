...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from remotes where mid=3");
...
%>  
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/accessories/remote3.jpg" width="370" height="400">
    				<h3 style="font-size: 20px;">UNIV WIRELESS REMOTES</h3>
    			</div>
    			<div class="col-md-4">
    				<table class="table table-striped table table-bordered" style="border: 1px solid; color: black;">
                <tr >
                    <td>MODEL NAME</td><td>UNIV WIRELESS REMOTES</td>
                   
                </tr>
                <tr >
                    <td>MODEL NUMBER</td><td>UAL231MSG</td>
                ...
                <tr>
                    ...
                    <td>BRAND NAME</td><td>UNIVERSAL</td>
                ...
                <tr>
                    ...
                    <td>MOVING SPEED(m/min)</td><td>0.65*0.32*0.15mm</td>
