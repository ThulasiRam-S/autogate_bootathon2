...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from sensors where mid=4");
...
%>  
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/accessories/sensor4.png" width="370" height="400">
    				<h3 style="font-size: 20px;">YET611 AUTOMATIC INFRARED SENSOR GATE PHOTOCELL SAFETY BEAMS SYSTEM</h3>
    			</div>
    			<div class="col-md-4">
    				 <table class="table table-striped table table-bordered" style="border: 1px solid; color: black;">
                <tr >
                    <td>MODEL</td><td>
YET611  Automatic Infrared Sensor Gate photocell Safety Beams System  </td>
                ...
                <tr>
                    ...
                    <td>DETECTING DISTANCE</td><td>12 - 18 METERS</td>
