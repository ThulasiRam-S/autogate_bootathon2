...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from remotes where mid=4");
...
%>  
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/accessories/remote4.png" width="370" height="400">
                ...
                <tr >
                    <td>MODEL NUMBER</td><td>YET609</td>
