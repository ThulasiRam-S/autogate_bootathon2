...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from roller_gate_opener where mid=3");
...
%>  
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/roller motor/roller3.jpeg" width="370" height="400">
    				<h3>DOORTEC-2 ROLLER GATE OPENER</h3>
    			</div>
    			<div class="col-md-4">
    				 <table class="table table-striped table table-bordered" style="border: 1px solid; color: black;">
                <tr >
                    <td>BRAND NAME</td><td>DOORTEC-2</td>
