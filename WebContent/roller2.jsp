...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from roller_gate_opener where mid=2");
...
%>  
	    <div class="menu-bar">
	    	<div class="row">
	            ...
	            <ul class="nav" >
	                <li><a href="roller_gate.jsp">Back</a></li>
	           </ul>
	    	</div>
	    </div>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/roller motor/roller2.jpeg" width="370" height="400">
    				<h3>DOORTEC ROLLER GATE OPENER</h3>
    			</div>
    			<div class="col-md-4">
...
AC/DC 12-24V</td>
                ...
                <tr>
                    ...
                    <td>AMBIENT TEMPERATURE RANGE</td><td>-20 ~ +60</td>
