...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from sliding_gate where mid=3");
...
%>  
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/sliding_motor/GULLIVER_PRINCIPALE_1.jpg" width="370" height="400">
    				<h3>GULLIVER SLIDING GATE</h3>
    			</div>
    			<div class="col-md-4">
    				 <table class="table table-striped table table-bordered" style="border: 1px solid; color: black;">
                <tr >
                    <td>MODEL</td><td>GULLI-550M</td>
                ...
                <tr>
                    ...
                    <td>Max.GATE WEIGHT</td><td>2500kg</td>
