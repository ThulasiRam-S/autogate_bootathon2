...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from garage_gate_opener where mid=1");
...
%>  
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/garagedoor_opener/201502121838305344.jpg" width="370" height="400">
...
(F-850E)</td>
                ...
                <tr>
                    ...
                    <td>Max.GATE WEIGHT</td><td>600</td>
