...
try {
    ...
    ResultSet rst=pst.executeQuery("SELECT model_name from swing_gate where mid=4");
...
%>  
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-5">
    				<img class="image" src="bootathon2/swing_motor/STING_PRINCIPALE_2.jpg" width="370" height="400">
    			</div>
    			<div class="col-md-4">
    				 <table class="table table-striped table table-bordered" style="border: 1px solid; color: black;">
                <tr >
                    <td>MODEL</td><td>STING AUTOMATION</td>
                ...
                <tr>
                    ...
                    <td>Max.GATE WEIGHT</td><td>400</td>
